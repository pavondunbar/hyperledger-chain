...
let oked=0
let total=0
declare -a allpeernodes=(peer1.org1.movo.cash peer2.org1.movo.cash peer3.org1.movo.cash peer4.org1.movo.cash)
...
declare -a allorderernodes=(orderer1.movo.cash orderer2.movo.cash)
